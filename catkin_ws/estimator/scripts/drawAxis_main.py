...
if __name__ == '__main__':
	...
	while True:
		...
		#print detected
		if detected == True:
			rvecs, tvecs, _objPoints = cv.aruco.estimatePoseSingleMarkers( corners, 0.106, mtx, dist)
			#print 'rvecs: ', rvecs ,'\n\n'
			print 'tvecs: ', tvecs, '\n\n'
			print tvecs[0][0][0]
			...
			#mrk.drawBoxAndShow()
			#print('rvec type: ', type(rvecs),'tvec type: ',type(tvecs),'_objPoints type: ',type(_objPoints))
